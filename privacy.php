<?php 
	$currentPage = 'privacy-policy'; // current page name....
	include 'header.php'; ?>
...
<section class = "main-content">
	...
	<section class = "about-banner banner-inner-top">
	...
	<section class = "about-a terms-services">
		<div class = "container">
			<div class = "row">
				<div class = "col-12">
                    ...
                    <p>
                        <strong>Personal Information Provided by You.</strong> We collect names; phone numbers; email addresses; billing addresses; debit/credit card numbers; contact or authentication data; contact preferences; and other similar information.
                    </p>
                    ...
                    <p>
                        <i><strong>In Short:</strong> Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Website.</i>
                    </p>
                    ...
                    <p>
                        <i><strong>In Short:</strong>  We process your information for purposes based on legitimate business interests, the fulfillment of our contract with you, compliance with our legal obligations, and/or your consent.</i>
                    </p>
                    ...
                    <ul>
                        ...
                        <li><strong>To send you marketing and promotional communications.</strong> We and/or our third-party marketing partners may use the personal information you send to us for our marketing purposes, if this is in accordance with your marketing preferences. For example, when expressing an interest in obtaining information about us or our Website, subscribing to marketing or otherwise contacting us, we will collect personal information from you. You can opt-out of our marketing emails at any time (see the <a href="">"WHAT ARE YOUR PRIVACY RIGHTS?"</a> below).</li>
                    ...
                    <p>
                       <i><strong>In Short:</strong>  We only share information with your consent, to comply with laws, to provide you with services, to protect your rights, or to fulfill business obligations.</i>
                    </p>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <br/><br/>
                            <span class = "text-uderline">Opting out of email marketing:</span> You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list — however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may:
                        </li>
                    ...
                    <p>
                        <span class="text-underline">Right to request deletion of the data - Request to delete</span>
                    </p>
                    ...
                    <p>
                        <span class="text-underline">Right to be informed - Request to know</span>
                    </p>
                    ...
                    <p>
                        <span class="text-underline">Right to Non-Discrimination for the Exercise of a Consumer’s Privacy Rights</span>
                    </p>
                    ...
                    <p><span class="text-underline">Verification process</span></p>
                    ...
                    <p>
                        <span class="text-underline">Other privacy rights</span>
                    </p>
