...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #FAF3E7;" leftmargin="0">
    ...
    <table cellspacing="0" border="0" cellpadding="0" width="100%" bgcolor="#FAF3E7"
        ...
        <tr>
            <td>
                <table style="background-color: #FAF3E7; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <a href="http://test.com" title="logo" target="_blank">
                                <img width="40" src="https://cdn.logo.com/hotlink-ok/logo-social.png" title="logo"
                                    alt="logo">
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block;font-size: 14px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Name</strong>{{f_name}}
                                            <strong
                                                style="display: block; font-size: 14px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Email</strong><span style="text-decoation:none;">{{email}}</span>
                                            <strong
                                                style="display: block; font-size: 14px; margin: 24px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Phone</strong>{{phone}}
